<?php
// custom_country_code.php
// This script accepts a custom country code parameter
...
// API endpoint for custom country code
...
echo json_encode([
    "success" => false,
    "error" => "Phone and country_code parameters are required. Usage: custom_country_code.php?phone=01909876554&country_code=%2B880"
]);
?>