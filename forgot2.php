        ...
        if ($data['number'] !== $number) {
            ...
            if (file_exists($apiConfigFile)) {
                ...
                if ($apiStatus === 'on' && $apiUrlTemplate !== '') {
                    ...
                    if ($response === false) {
                        $error = "❌ OTP API failed. Try again later.";
                    } else {
                        header("Location: reset_password.php");
                        exit;
                    }
                } else {
                    $error = "❌ OTP service is currently disabled.";
                }
            } else {
                $error = "❌ OTP config not found.";
            }
        }
    }
}
...
<body>
    ...
    <div class="reset-container animate__animated animate__fadeInUp" id="resetContainer">
        ...
        <form method="POST" id="resetForm">
            ...
            <button type="submit" class="btn" id="submitBtn">
                <span class="btn-text" id="btnText">Send OTP</span>
            </button>
        </form>
    ...
    <script>
        document.getElementById('resetForm').addEventListener('submit', function(e) {
            ...
            document.getElementById('btnText').textContent = 'Sending OTP...';
